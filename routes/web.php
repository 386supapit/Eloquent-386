...
Route::get('/productcustomers', function () {
    $productCustomers = ProductCustomer::all();
    return view('productcustomers', compact('productCustomers'));
});
...
Route::get('/roomcustomers', function () {
    $roomCustomers = RoomCustomer::all();
    return view('roomcustomers', compact('roomCustomers'));
});
...
Route::get('/bookings', function () {
    $bookings = Booking::with('roomCustomer')->get();
